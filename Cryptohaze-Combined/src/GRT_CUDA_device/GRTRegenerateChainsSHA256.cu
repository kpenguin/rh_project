...
extern "C" void copySHA256RegenerateDataToConstant(char *hostCharset, uint32_t hostCharsetLength,
    ...
    CUDA_SAFE_CALL(cudaMemcpyToSymbol(SHA256_Regenerate_Device_Charset_Constant, hostCharset, 512));
    CUDA_SAFE_CALL(cudaMemcpyToSymbol(SHA256_Regenerate_Device_Charset_Length, &hostCharsetLength, sizeof(uint32_t)));
    CUDA_SAFE_CALL(cudaMemcpyToSymbol(SHA256_Regenerate_Device_Chain_Length, &hostChainLength, sizeof(uint32_t)));
    CUDA_SAFE_CALL(cudaMemcpyToSymbol(SHA256_Regenerate_Device_Table_Index, &hostTableIndex, sizeof(uint32_t)));
    CUDA_SAFE_CALL(cudaMemcpyToSymbol(SHA256_Regenerate_Device_Number_Of_Threads, &hostNumberOfThreads, sizeof(uint32_t)));
    CUDA_SAFE_CALL(cudaMemcpyToSymbol(constantBitmap, hostBitmap, 8192));
    CUDA_SAFE_CALL(cudaMemcpyToSymbol(SHA256_Regenerate_Device_Number_Of_Hashes, &hostNumberOfHashes, sizeof(uint32_t)));
}

extern "C" void setSHA256RegenerateNumberOfChains(uint32_t numberOfChains) {
    CUDA_SAFE_CALL(cudaMemcpyToSymbol(SHA256_Regenerate_Device_Number_Of_Chains_To_Regen, &numberOfChains, sizeof(uint32_t)));
}
